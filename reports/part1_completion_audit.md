...
| required report exists: reports/data_raw_review.md                      | PASS     |                                                                                                                                                 |
| required report exists: reports/part1_plan_implementation_review.md     | PASS     |                                                                                                                                                 |
...
| data contract documents optional test typewell Geology                  | PASS     |                                                                                                                                                 |
| raw-data review documents PPTX and sample submission                    | PASS     |                                                                                                                                                 |
| raw-data review marks visible test as sanity only                       | PASS     |                                                                                                                                                 |
...
| cv_design documents official-tail priority and stress masks             | PASS     |                                                                                                                                                 |
| cv_design documents optional Geology boundary                           | PASS     |                                                                                                                                                 |
...
| part1 plan implementation review passes                                 | PASS     |                                                                                                                                                 |
| visible sample wells overlap train and are not independent validation   | PASS     | 000d7d20,00bbac68,00e12e8b                                                                                                                      |
| visible test typewell lacks Geology and scripts must fallback           | PASS     | wells=3                                                                                                                                         |
| submission report marks visible examples as sanity only                 | PASS     |                                                                                                                                                 |
