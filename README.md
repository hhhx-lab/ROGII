...
The committed reports, figures, and submission CSVs can also be regenerated by the same command sequence. The current Part 1 audit expects `outputs/` to exist locally and reports `40 checks, 0 failures` when the artifacts match the data bundle.
