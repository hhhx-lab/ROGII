...
## Server Part 2 Full Run

Part 2 has a full-row server workflow for rerunning the residual geometry model before entering GR/typewell alignment. The beginner-friendly operation guide is:

[`docs/operations/part2_server_full_run_guide.md`](docs/operations/part2_server_full_run_guide.md)
